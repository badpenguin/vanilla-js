...
$addClass(b,"open"),n=window.scrollY||window.scrollTop||document.getElementsByTagName("html")[0].scrollTop,l=document.body.style.position,g=document.body.style.width,v=document.documentElement.style["scroll-behavior"],document.body.style.position="fixed",document.body.style.top="-"+n+"px",document.body.style.width="100%",document.documentElement.style.scrollBehavior="auto")};a.prototype.then=function(a){h=a;return this};a.prototype.getStatus=function(a){return!!f};return a}();
