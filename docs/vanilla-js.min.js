...
function $formDecorateFieldAsPhone(a,c){var b=$one(a),d=RegExp(c||"[0-9+]");$on(b,"keypress",function(a){if("paste"===a.type)b=(event.clipboardData||window.clipboardData).getData("text/plain");else var b=a.keyCode||a.which,b=String.fromCharCode(b);d.test(b)||(a.returnValue=!1,a.preventDefault&&a.preventDefault())})};var $form=function(){var a,c,b,d,e,g,f,n,l;function h(a,b){E&&("undefined"!==typeof b?console.debug(a,b):console.debug(a))}function v(a){a.forEach(function(a){h("! disable",a.name||a.id||a.className||a.type);a.setAttribute("disabled","disabled")})}function p(a){a.forEach(function(a){h("enable",a);a.removeAttribute("disabled")})}function k(z,s){if(!this)throw'$form: You forgot to use "new" to create the object';if(!z)throw"$form: You did not provide an element";m=$one(z);if(!m)throw"$form: element not found for: "+
z;s=s||{};a=s.action||!1;c=s.validClass||"is-valid";b=s.validClass||"is-invalid";d=s.dirtyClass||"is-dirty";e=s.pristineClass||"is-pristine";g=s.fieldParentSelector||"div";f=s.disableSubmit||!1;A=s.onFormValidate||null;n=s.alertSubmit||!1;l=s.errorMessageClass||"error-message";var p=s.debounceTime||300;C=$debounce(this.validate.bind(this),p,!1);D=$debounce(this.validateField.bind(this),p,!1);m.setAttribute("novalidate","");f&&(w=m.querySelectorAll("input[type=submit]"),v(w));y=m.querySelectorAll("input[type=reset],input[type=button]");
v(y);var p=m.querySelectorAll('input:not([type="submit"]):not([type="reset"]),textarea,select'),k=this;$forEach(p,function(a){h("! initialize",a.name||a.id);a.isDirty=!1;$on(a,"blur",function(a){h("! ON blur",a.target.name||a.target.id);C()});$on(a,"input",function(b){h("! ON input",b.target.name||b.target.id);t=a.isDirty=!0;D(b.target.name||b.target.id)})});m.addEventListener("submit",function(b){h("! on submit");b.preventDefault();k.validate()?a&&m.setAttribute("action",a):(x&&$scrollIntoView(x),
n&&$alert("ATTENZIONE",n))})}var E=!1,u={},B={},q={},t=!1,r=!1,m=null,C=null,D=null,A=null,y=null,w=null;l=n=f=g=e=d=b=c=a=void 0;var x=null;k.prototype.addValidator=function(a,b){u.hasOwnProperty(a)||(u[a]=[]);u[a].push(b);h("- addValidator =",u);return this};k.prototype.validate=function(){h("! validate()...");var a=this._checkForm();this._reportForm(a);return r};k.prototype._checkForm=function(){var a=!0;x=null;for(var b in u){var c=this.checkField(b);!0!==c&&(a=!1);this.reportField(b,c)}A&&(h("-- calling onFormValidate..."),
a=A(m,a));h("-- _checkForm =",a);return a};k.prototype.checkField=function(a){h("- checkField()...",a);if(!u.hasOwnProperty(a))return console.warn("$form::checkField, does not exists: ",a),!0;for(var b=u[a],c=0;c<b.length;c++){var d=b[c];this.getFieldObject(a);var e=this.getFieldValue(a),d=d(e);if(!0!==d)return h("-- check failed terminating",d),d}return!0};k.prototype.getFieldObject=function(a){if(B.hasOwnProperty(a))return B[a];var b=m.querySelector('[name="'+a+'"],[id="'+a+'"]');return B[a]=b};
...
c=0;c<a.length;c++)b.push(a[c].value);return b}return b.value};k.prototype.reportField=function(a,f){var p=this.getFieldObject(a);if(p){var k=$closest(p,g);if(!0===f){$removeClass(k,b);$addClass(k,c);p.isValid=!0;var h=this.getFieldErrorMessageObject(a,null);h&&(h.innerHTML="")}else{$addClass(k,b);$removeClass(k,c);p.isValid=!1;if(h=this.getFieldErrorMessageObject(a,k))h.innerHTML=f;null===x&&(x=p)}p.hasOwnProperty("isDirty")&&(p.isDirty?($addClass(k,d),$removeClass(k,e)):($addClass(k,e),$removeClass(k,
...
var $dialog=function(){function a(a){a=a||{};var f=a.title||"",h=a.className||"",l=a.disableDismiss||!1,n=Array.isArray(a.buttons)?a.buttons:[],q=a.content||"",t=a.spinner||"",r=a.disableClose||!1;g=a.promiseCallback||null;b=$id(c);if(!b){d=document.createElement("div");$addClass(d,"dialog-window__inner");e=document.createElement("button");$addClass(e,"dialog-window__close");e.innerHTML="&times;";a=document.createElement("div");$addClass(a,"dialog-window");a.appendChild(e);a.appendChild(d);b=document.createElement("div");
b.setAttribute("id",c);$addClass(b,"dialog-backdrop");b.appendChild(a);document.body.appendChild(b);var m=this;e.addEventListener("click",function(a){a.preventDefault();a.stopPropagation();m.hide()});b.addEventListener("click",function(a){a.target===a.currentTarget&&(a.preventDefault(),l||m.hide())})}b.className="dialog-backdrop";h&&$addClass(b,h);e.style.display=r?"none":"block";$empty(d);f&&(h=document.createElement("div"),$addClass(h,"dialog-window__title"),h.innerHTML=f,d.appendChild(h));q&&(f=
document.createElement("div"),$addClass(f,"dialog-window__content"),f.innerHTML=q,d.appendChild(f));t&&(q=document.createElement("div"),$addClass(q,"dialog-window__spinner"),$addClass(q,t),d.appendChild(q));if(0<n.length){t=document.createElement("div");$addClass(t,"dialog-window__buttons");d.appendChild(t);for(q=0;q<n.length;q++)r=n[q],$isString(r)&&(r={label:r}),f=r.label||"OK",h=r.className||(0==q?"btn--primary btn--large":"btn--secondary"),r=r.value||r.label,a=document.createElement("button"),
a.className="btn "+h,a.innerHTML=f,a.onclick=this.hide.bind(this,r),t.appendChild(a)}this.show()}var c="vanilla-dialog",b=null,d=null,e=null,g=null,f=!1,n="",l="",h="",v="";a.prototype.hide=function(a){f?(f=!1,document.body.style.position=l,document.body.style.width=h,window.scrollTo(0,n),document.documentElement.style.scrollBehavior=v,$removeClass(b,"open"),$empty(d),g&&$isFunction(g)&&g(a)):console.debug("$dialog: already closed")};a.prototype.show=function(){f?console.debug("$dialog: already open"):
(f=!0,$addClass(b,"open"),n=window.scrollY||window.scrollTop||document.getElementsByTagName("html")[0].scrollTop,l=document.body.style.position,h=document.body.style.width,v=document.documentElement.style["scroll-behavior"],document.body.style.position="fixed",document.body.style.top="-"+n+"px",document.body.style.width="100%",document.documentElement.style.scrollBehavior="auto")};a.prototype.then=function(a){g=a;return this};a.prototype.getStatus=function(a){return!!f};return a}();
