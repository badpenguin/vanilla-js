...
else return b.images=[],b.options={autoLoad:!1,cancelInitialLoad:!1},b.options=Object.assign(b.options,c),b.preloadImage=function(b){var a=b.getAttribute("data-src");if(a&&(b.removeAttribute("data-src"),$addClass(b,"lazyloading"),b.onload=function(){$addClass(b,"lazyloaded");$removeClass(b,"lazyloading")},b.setAttribute("src",a),a=b.getAttribute("data-srcset")))b.removeAttribute("data-srcset"),b.setAttribute("srcset",a)},$onReady(function(){if("IntersectionObserver"in window)if("IntersectionObserver"in
window){var e=new IntersectionObserver(function(a,e){a.forEach(function(a){a.isIntersecting&&(b.preloadImage(a.target),e.unobserve(a.target))})},{rootMargin:"400px",threshold:0});b.images=[];$all(a).forEach(function(a){if(b.options.cancelInitialLoad){var c=a.getAttribute("src");c&&(a.removeAttribute("src"),a.setAttribute("data-src",c))}a.hasAttribute("data-src")&&(a.src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=",$addClass(a,"lazyloading"),c=a.getAttribute("srcset"),a.removeAttribute("srcset"),
c&&a.setAttribute("data-srcset",c),e.observe(a),b.images.push(a))});b.options.autoLoad&&$onLoad(function(){b.images.forEach(function(a,e){setTimeout(function(){b.preloadImage(a)},1E3*(e+2))})})}else console.warn("[onPageReady] $lazyload: not supported.");else console.warn("[$onReady] $lazyload: not supported.")}),{}};function $disableScreenScrolling(){document.body.style.touchAction="none";$addClass(document.body,"bp-disable-scroll")}function $restoreScreenScrolling(){document.body.style.touchAction="";$removeClass(document.body,"bp-disable-scroll")}var lightboxInstanceCount=0;
...
$find(a,c).forEach(function(a){b.scanElement(a)}):b.scanElement(a)});1===b.images.length&&(b.singleMode=!0,$addClass(b.modal,"singleMode"))},bootstrap:function(){b.initialized||(b.checkModal(),b.checkImages(),b.initialized=!0)},switchImage:function(a){b.currentIndex=a;var d=null,c=null;0===b.currentIndex%2?(d=b.modalImage1,c=b.modalImage2):(d=b.modalImage2,c=b.modalImage1);c.setAttribute("title","");b.modalCaption.innerText="";d.src=b.images[a][0];if(a=b.images[a][1])d.setAttribute("title",a),b.modalCaption.innerText=
a},show:function(a){b.hide();b.switchImage(a);b.isOpen=!0;$disableScreenScrolling();setTimeout(function(){$addClass(b.modal,"open")},0);b.preloadImages()},preloadImages:function(){b.images.map(function(a){return a[0]}).unique().slice(1).forEach(function(a){(new Image).src=a})},hide:function(){b.isOpen=!1;$removeClass(b.modal,"open");$restoreScreenScrolling();b.modalImage1.style.opacity="0";b.modalImage2.style.opacity="0"},next:function(){if(!b.singleMode){var a=b.currentIndex+1;if(a<b.images.length)return b.switchImage(a)}b.hide()},
prev:function(){if(!b.singleMode){var a=b.currentIndex-1;if(0<=a)return b.switchImage(a)}b.hide()},detectUrl:function(a){a=a.getAttribute("data-src")||a.getAttribute("href")||a.getAttribute("src");for(var c=0;c<b.images.length;c++)if(b.images[c][0]===a)return c;return!1}};b.insertCss();$on(a,"click",function(c){b.bootstrap();if(0===b.images.length)console.warn("$lightbox: no images found");else{for(var d=c.target,g=b.detectUrl(d);!1===g;){if(d.matches(a)){console.warn("$lightbox: clicked element url not found in main selector");
