...
function $onSwipe(a,c,b){null===a&&(a=window.document);if(!a)return console.error("$onSwipe invalid element"),!1;var d=0,e=0,h=0,f=0;b||(b=50);a.addEventListener("touchstart",function(b){d=b.changedTouches[0].screenX;e=b.changedTouches[0].screenY},{passive:!0});a.addEventListener("touchend",function(a){h=a.changedTouches[0].screenX;f=a.changedTouches[0].screenY;var l=h-d,g=f-e;if(Math.abs(l)>Math.abs(g)){if(Math.abs(l)>b)return 0>l?c("left",a):c("right",a)}else if(Math.abs(g)>b)return 0<g?c("down",
...
function isObject(a){return null!=a&&"object"==typeof a}function isFunction(a){return"function"==typeof a};var $ajax=function(a,c,b,d){var e=new XMLHttpRequest;e.open(a,c,!0);isObject(b)||(console.warn("$ajax: options is not an object"),b={});b.timeout&&(console.warn("setting timeout"),e.timeout=b.timeout);b.withCredentials&&(e.withCredentials=b.withCredentials);a=b.data||null;var h=b.debug||!1,f=b.responseType||!1;e.setRequestHeader("X-Requested-With","XMLHttpRequest");if(b.sendUrlencoded){e.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=UTF-8");c=[];for(var n in a)a.hasOwnProperty(n)&&
c.push(encodeURIComponent(n)+"="+encodeURIComponent(a[n]));a=c.join("&").replace(/%20/g,"+")}b.sendFormData&&e.setRequestHeader("Content-Type","multipart/form-data");b.sendJson&&(e.setRequestHeader("Content-Type","application/json; charset=UTF-8"),a=JSON.stringify(a),f||(f="json"));if(b.headers)for(var l in b.headers)b.headers.hasOwnProperty(l)&&e.setRequestHeader(l,b.headers[l]);b.onprogress&&(getObject(e,"upload.onprogress")?(console.warn("hook upload"),e.upload.onprogress=function(a){var e=Math.round(100*
(a.loaded/a.total));b.onprogress(e,a)}):console.warn("$ajax.js: no upload hook available"));f&&(e.responseType=f);e.onreadystatechange=function(){h&&console.debug("[$ajax] onreadystatechange",e.readyState,e.status,e.statusText)};e.onload=function(){h&&console.log("[$ajax] onload",e.status,e.statusText);var b=200<=e.status&&300>e.status,a={status:e.status,response:e.response,responseType:e.responseType};"json"===f&&"string"===typeof e.response&&(a.response=JSON.parse(e.response),a.responseType="json");
var c=null;a.hasOwnProperty("response")&&(a.response.hasOwnProperty("error")&&a.response.hasOwnProperty("payload"))&&(c=0===a.response.error?a.response.payload:!1);d(b,a,c)};e.onabort=function(){console.warn("[$ajax] onabort",e.status,e.statusText);d(!1,e,null)};e.onerror=function(){console.error("[$ajax] onerror",e.status,e.statusText);d(!1,e,null)};e.ontimeout=function(){console.error("[$ajax] ontimeout",e.status,e.statusText);d(!1,e,null)};b.data?e.send(a):e.send();return e};function getCookie(a){return(a=document.cookie.match("(^|;) ?"+a+"=([^;]*)(;|$)"))?a[2]:null}function setCookie(a,c,b){var d=new Date;d.setTime(d.getTime()+864E5*b);document.cookie=a+"="+c+";path=/;expires="+d.toGMTString()}function removeCookie(a){setCookie(a,"",-1)};function $copyright(a,c){var b={};b.title=a||"This material is copyright by the author - All Right Reserved";b.notify=function(){console.warn(b.title);isFunction(c)&&c(b.title)};window.document.addEventListener("contextmenu",function(a){a.preventDefault();b.notify();return!1},!1);window.document.addEventListener("copy",function(a){a.preventDefault();a.clipboardData.setData("text/plain",b.title);b.notify();return!1},!1);window.document.addEventListener("dragstart",function(a){a.preventDefault();b.notify();
...
$find(a,c).forEach(function(a){b.scanElement(a)}):b.scanElement(a)});1===b.images.length&&(b.singleMode=!0,$addClass(b.modal,"lightbox-modal--single-mode"))},bootstrap:function(){b.initialized||(b.checkModal(),b.checkImages(),b.initialized=!0)},switchImage:function(a){b.currentIndex=a;var e=null,c=null;0===b.currentIndex%2?(e=b.modalImage1,c=b.modalImage2):(e=b.modalImage2,c=b.modalImage1);c.setAttribute("title","");b.modalCaption.innerText="";e.src=b.images[a][0];if(a=b.images[a][1])e.setAttribute("title",
...
b.currentIndex+1;if(a<b.images.length)return b.switchImage(a)}b.hide()},prev:function(){if(!b.singleMode){var a=b.currentIndex-1;if(0<=a)return b.switchImage(a)}b.hide()},detectUrl:function(a){a=a.getAttribute("data-src")||a.getAttribute("href")||a.getAttribute("src");for(var e=0;e<b.images.length;e++)if(b.images[e][0]===a)return e;return!1}};b.insertCss();$on(a,"click",function(c){b.bootstrap();if(0===b.images.length)console.warn("$lightbox: no images found");else{for(var e=c.target,h=b.detectUrl(e);!1===
h;){if(e.matches(a)){console.warn("$lightbox: clicked element url not found in main selector");return}e=e.parentNode;if("function"!==typeof e.getAttribute){console.error("$lightbox: cannot find the clicked element in document");return}h=b.detectUrl(e)}c.preventDefault();c.stopImmediatePropagation();return b.show(h)}});return{}};function $scrollDetector(a){function c(a){d!==a&&(d=a,$triggerEvent(window.document,"scroll-"+a))}var b=window.pageYOffset,d="";a=a?a:100;document.addEventListener("scroll",function(e){e=window.pageYOffset;if(Math.abs(e-b)>a){var d=e>b?"down":"up";b=e;return c(d)}if(0===e)return b=e,c("top");if(window.pageYOffset+window.innerHeight+a>(void 0!==document.height?document.height:document.body.offsetHeight))return b=e,c("bottom")})};function $inViewport(a,c){var b=a.getBoundingClientRect();return 0<=b.top&&b.top+c<=(window.innerHeight||document.documentElement.clientHeight)}function $windowScrollTop(){return window.scrollY||document.body.scrollTop||document.documentElement.scrollTop}
...
Array.isArray||(Array.isArray=function(a){return"[object Array]"===Object.prototype.toString.call(a)});function $debounce(a,c,b){b="undefined"!==typeof b?b:!1;c=c||20;var d=null;return function(){var e=this,h=arguments,f=b&&!d;clearTimeout(d);d=setTimeout(function(){d=null;b||a.apply(e,h)},c);f&&a.apply(e,h)}}
function $scrollIntoView(a,c){if(!a)return!1;c=c||100;if("scrollBehavior"in document.documentElement.style)return a.scrollIntoView({block:"center"}),!0;if(window.hasOwnProperty("scroll")){var b=a.getBoundingClientRect(),d=document.body,e=document.documentElement,b=b.top+(window.pageYOffset||e.scrollTop||d.scrollTop)-(e.clientTop||d.clientTop||0);b>=c&&(b-=c);window.scrollTo(0,b);return!0}console.warn("vanillaScroll cannot scroll");return!1}
...
function $formDecorateFieldAsPhone(a,c){var b=$one(a),d=RegExp(c||"[0-9+]");$on(b,"keypress",function(a){if("paste"===a.type)b=(event.clipboardData||window.clipboardData).getData("text/plain");else var b=a.keyCode||a.which,b=String.fromCharCode(b);d.test(b)||(a.returnValue=!1,a.preventDefault&&a.preventDefault())})};var $form=function(){var a,c,b,d,e,h,f,n,l;function g(a,b){E&&("undefined"!==typeof b?console.debug(a,b):console.debug(a))}function v(a){a.forEach(function(a){g("! disable",a.name||a.id||a.className||a.type);a.setAttribute("disabled","disabled")})}function p(a){a.forEach(function(a){g("enable",a);a.removeAttribute("disabled")})}function k(z,s){if(!this)throw'$form: You forgot to use "new" to create the object';if(!z)throw"$form: You did not provide an element";m=$one(z);if(!m)throw"$form: element not found for: "+
z;s=s||{};a=s.action||!1;c=s.validClass||"is-valid";b=s.validClass||"is-invalid";d=s.dirtyClass||"is-dirty";e=s.pristineClass||"is-pristine";h=s.fieldParentSelector||"div";f=s.disableSubmit||!1;A=s.onFormValidate||null;n=s.alertSubmit||!1;l=s.errorMessageClass||"error-message";var p=s.debounceTime||300;C=$debounce(this.validate.bind(this),p,!1);D=$debounce(this.validateField.bind(this),p,!1);m.setAttribute("novalidate","");f&&(w=m.querySelectorAll("input[type=submit]"),v(w));y=m.querySelectorAll("input[type=reset],input[type=button]");
v(y);var p=m.querySelectorAll('input:not([type="submit"]):not([type="reset"]),textarea,select'),k=this;$forEach(p,function(a){g("! initialize",a.name||a.id);a.isDirty=!1;$on(a,"blur",function(a){g("! ON blur",a.target.name||a.target.id);C()});$on(a,"input",function(b){g("! ON input",b.target.name||b.target.id);t=a.isDirty=!0;D(b.target.name||b.target.id)})});m.addEventListener("submit",function(b){g("! on submit");b.preventDefault();k.validate()?a&&m.setAttribute("action",a):(x&&$scrollIntoView(x),
n&&$alert("ATTENZIONE",n))})}var E=!1,u={},B={},q={},t=!1,r=!1,m=null,C=null,D=null,A=null,y=null,w=null;l=n=f=h=e=d=b=c=a=void 0;var x=null;k.prototype.addValidator=function(a,b){u.hasOwnProperty(a)||(u[a]=[]);u[a].push(b);g("- addValidator =",u);return this};k.prototype.validate=function(){g("! validate()...");var a=this._checkForm();this._reportForm(a);return r};k.prototype._checkForm=function(){var a=!0;x=null;for(var b in u){var c=this.checkField(b);!0!==c&&(a=!1);this.reportField(b,c)}A&&(g("-- calling onFormValidate..."),
a=A(m,a));g("-- _checkForm =",a);return a};k.prototype.checkField=function(a){g("- checkField()...",a);if(!u.hasOwnProperty(a))return console.warn("$form::checkField, does not exists: ",a),!0;for(var b=u[a],c=0;c<b.length;c++){var d=b[c];this.getFieldObject(a);var e=this.getFieldValue(a),d=d(e);if(!0!==d)return g("-- check failed terminating",d),d}return!0};k.prototype.getFieldObject=function(a){if(B.hasOwnProperty(a))return B[a];var b=m.querySelector('[name="'+a+'"],[id="'+a+'"]');return B[a]=b};
k.prototype.getFieldErrorMessageObject=function(a,b){if(q.hasOwnProperty(a))return q[a];if(b){var c=document.createElement("div");$addClasses(c,l);q[a]=c;b.appendChild(c);return c}return null};k.prototype.getFieldValue=function(a){var b=this.getFieldObject(a);if("radio"===b.type)return a=m.querySelector('[name="'+a+'"]:checked,[id="'+a+'"]:checked'),!a?null:a.value;if("checkbox"===b.type){a=m.querySelectorAll('[name="'+a+'"]:checked,[id="'+a+'"]:checked');if(0===a.length)return null;for(var b=[],
c=0;c<a.length;c++)b.push(a[c].value);return b}return b.value};k.prototype.reportField=function(a,f){var p=this.getFieldObject(a);if(p){var k=$closest(p,h);if(!0===f){$removeClass(k,b);$addClass(k,c);p.isValid=!0;var g=this.getFieldErrorMessageObject(a,null);g&&(g.innerHTML="")}else{$addClass(k,b);$removeClass(k,c);p.isValid=!1;if(g=this.getFieldErrorMessageObject(a,k))g.innerHTML=f;null===x&&(x=p)}p.hasOwnProperty("isDirty")&&(p.isDirty?($addClass(k,d),$removeClass(k,e)):($addClass(k,e),$removeClass(k,
d)))}else console.warn("$form::reportField, cannot find element for:",a)};k.prototype._reportForm=function(a){!0===a?(r=!0,$removeClass(m,b),$addClass(m,c),w&&p(w)):(r=!1,w&&v(w),$addClass(m,b),$removeClass(m,c));t&&y&&(p(y),y=null)};k.prototype.getFirstWrongElement=function(){return x};k.prototype.validateField=function(a){var b=this.checkField(a);this.reportField(a,b);return b};return k}();function $isFunction(a){return a&&"[object Function]"==={}.toString.call(a)}
var $dialog=function(){function a(a){a=a||{};var f=a.title||"",g=a.className||"",l=a.disableDismiss||!1,n=Array.isArray(a.buttons)?a.buttons:[],q=a.content||"",t=a.spinner||"",r=a.disableClose||!1;h=a.promiseCallback||null;b=$id(c);if(!b){d=document.createElement("div");$addClass(d,"dialog-window__inner");e=document.createElement("button");$addClass(e,"dialog-window__close");e.innerHTML="&times;";a=document.createElement("div");$addClass(a,"dialog-window");a.appendChild(e);a.appendChild(d);b=document.createElement("div");
b.setAttribute("id",c);$addClass(b,"dialog-backdrop");b.appendChild(a);document.body.appendChild(b);var m=this;a.addEventListener("click",function(a){a.preventDefault();a.stopPropagation()});e.addEventListener("click",function(a){m.hide()});b.addEventListener("click",function(a){a.preventDefault();l||m.hide()})}b.className="dialog-backdrop";g&&$addClass(b,g);e.style.display=r?"none":"block";$empty(d);f&&(g=document.createElement("div"),$addClass(g,"dialog-window__title"),g.innerHTML=f,d.appendChild(g));
q&&(f=document.createElement("div"),$addClass(f,"dialog-window__content"),f.innerHTML=q,d.appendChild(f));t&&(q=document.createElement("div"),$addClass(q,"dialog-window__spinner"),$addClass(q,t),d.appendChild(q));if(0<n.length){t=document.createElement("div");$addClass(t,"dialog-window__buttons");d.appendChild(t);for(q=0;q<n.length;q++)r=n[q],$isString(r)&&(r={label:r}),f=r.label||"OK",g=r.className||(0==q?"btn--primary btn--large":"btn--secondary"),r=r.value||r.label,a=document.createElement("button"),
a.className="btn "+g,a.innerHTML=f,a.onclick=this.hide.bind(this,r),t.appendChild(a)}this.show()}var c="vanilla-dialog",b=null,d=null,e=null,h=null,f=!1,n="",l="",g="",v="";a.prototype.hide=function(a){f?(f=!1,document.body.style.position=l,document.body.style.width=g,window.scrollTo(0,n),document.documentElement.style.scrollBehavior=v,$removeClass(b,"open"),h&&$isFunction(h)&&h(a)):console.debug("$dialog: already closed")};a.prototype.show=function(){f?console.debug("$dialog: already open"):(f=!0,
$addClass(b,"open"),n=window.scrollY||window.scrollTop||document.getElementsByTagName("html")[0].scrollTop,l=document.body.style.position,g=document.body.style.width,v=document.documentElement.style["scroll-behavior"],document.body.style.position="fixed",document.body.style.top="-"+n+"px",document.body.style.width="100%",document.documentElement.style.scrollBehavior="auto")};a.prototype.then=function(a){h=a};return a}();
function $backDrop(a){return new $dialog({content:a,spinner:"spinner2",disableDismiss:!0,disableClose:!0})}function $alert(a,c,b){return new $dialog({title:a,content:c,buttons:[b||"OK"],className:"dialog-backdrop--error"})}function $info(a,c,b){return new $dialog({title:a,content:c,buttons:[b||"OK"],className:"dialog-backdrop--info"})};
