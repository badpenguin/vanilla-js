...
NodeList.prototype.first=function(){return this.item(0)};function $find(c,d){return c.querySelectorAll(d)}function $append(c){document.body.insertAdjacentHTML("beforeend",c)}function $disableScreenScrolling(){document.body.style.height="100vh";document.body.style.overflow="hidden";document.body.style.position="fixed"}function $restoreScreenScrolling(){document.body.style.height="initial";document.body.style.overflow="initial";document.body.style.position="initial"}
...
"0";a.modalImage.setAttribute("title","");a.modalCaption.innerText="";var c=a.images[b][1];a.modalImage.src=a.images[b][0];c&&(a.modalImage.setAttribute("title",c),a.modalCaption.innerText=c)};a.show=function(b){a.hide();$disableScreenScrolling();a.switchImage(b);$show(a.modal);a.isOpen=!0;$addClass(a.modal,"open");a.modal.style.pointerEvents="auto";setTimeout(function(){a.modal.style.opacity="1"},0);a.singleMode?($hide(a.modalPrev),$hide(a.modalNext)):($show(a.modalPrev),$show(a.modalNext))};a.hide=
function(){$removeClass(a.modal,"open");a.modal.style.pointerEvents="none";a.modal.style.opacity="0";a.isOpen=!1;$restoreScreenScrolling()};a.next=function(){if(!a.singleMode){var b=a.currentIndex+1;if(b<a.images.length)return a.switchImage(b)}a.hide()};a.prev=function(){if(!a.singleMode){var b=a.currentIndex-1;if(0<=b)return a.switchImage(b)}a.hide()};a.detectUrl=function(b){b=b.getAttribute("data-src")||b.getAttribute("href")||b.getAttribute("src");for(var c=0;c<a.images.length;c++)if(a.images[c][0]===
b)return c;return!1};$on(c,"click",function(b){a.bootstrap();if(0===a.images.length)console.warn("$lightbox: no images found");else{b.preventDefault();b.stopImmediatePropagation();b=b.target;for(var d=a.detectUrl(b);!1===d;){if(b.matches(c)){console.warn("$lightbox: clicked element url not found in main selector");return}b=b.parentNode;if("function"!==typeof b.getAttribute){console.error("$lightbox: cannot find the clicked element in document");return}d=a.detectUrl(b)}return a.show(d)}})};
