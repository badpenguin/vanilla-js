...
a=c.join("&").replace(/%20/g,"+")}b.sendFormData&&e.setRequestHeader("Content-Type","multipart/form-data");b.sendJson&&(e.setRequestHeader("Content-Type","application/json; charset=UTF-8"),a=JSON.stringify(a),f||(f="json"));(b.sendJson||b.cors)&&e.setRequestHeader("X-Requested-With","XMLHttpRequest");if(b.headers)for(var l in b.headers)b.headers.hasOwnProperty(l)&&e.setRequestHeader(l,b.headers[l]);b.onprogress&&(getObject(e,"upload.onprogress")?(console.warn("hook upload"),e.upload.onprogress=function(a){var e=
