...
window.NodeList&&!NodeList.prototype.forEach&&(console.warn("[polyfill] NodeList.forEach"),NodeList.prototype.forEach=Array.prototype.forEach);"HTMLCollection"in window&&!HTMLCollection.prototype.forEach&&(console.warn("[polyfill] HTMLCollection.forEach"),HTMLCollection.prototype.forEach=Array.prototype.forEach);
Object.assign||(console.warn("[polyfill] Object.assign"),Object.defineProperty(Object,"assign",{enumerable:!1,configurable:!0,writable:!0,value:function(a,c){if(void 0===a||null===a)throw new TypeError("Cannot convert first argument to object");for(var b=Object(a),d=1;d<arguments.length;d++){var e=arguments[d];if(!(void 0===e||null===e))for(var e=Object(e),g=Object.keys(Object(e)),f=0,n=g.length;f<n;f++){var m=g[f],k=Object.getOwnPropertyDescriptor(e,m);void 0!==k&&k.enumerable&&(b[m]=e[m])}}return b}}));var $one=document.querySelector.bind(document),$id=document.getElementById.bind(document),$all=document.querySelectorAll.bind(document);function $find(a,c){return a.querySelectorAll(c)}NodeList.prototype.first=function(){return this.item(0)};var $forEach=function(a,c,b){for(var d=0;d<a.length;d++)c.call(b,a[d],d)},$allEach=function(a,c){var b=$all(a);if(!b)return console.warn("$allEach selector not found"),!1;b.forEach(c)};
...
b.modalImage1.addEventListener("load",function(){b.modalImage1.style.opacity="1";b.modalImage2.style.opacity="0"});b.modalImage2.addEventListener("load",function(){b.modalImage2.style.opacity="1";b.modalImage1.style.opacity="0"});b.modalNext.addEventListener("click",function(a){a.preventDefault();a.stopImmediatePropagation();b.next()});b.modalPrev.addEventListener("click",function(a){a.preventDefault();a.stopImmediatePropagation();b.prev()})},scanElement:function(a){var c=a.getAttribute("data-src")||
a.getAttribute("href")||a.getAttribute("src");if(c){var g=a.getAttribute("data-title")||a.getAttribute("title")||a.getAttribute("alt");if(!g){var f=$find(a,"img").first();f&&(g=f.getAttribute("data-title")||f.getAttribute("title")||f.getAttribute("alt"));if(!g)if(f=$find(a,"figcaption").first())g=f.innerText;else if((f=a.nextSibling)&&f.matches("figcaption"))g=f.innerText}b.images.push([c,g])}else console.warn("$lightbox: element has no valid image url",a)},checkImages:function(){$all(a).forEach(function(a){c?
$find(a,c).forEach(function(a){b.scanElement(a)}):b.scanElement(a)});1===b.images.length&&(b.singleMode=!0,$addClass(b.modal,"lightbox-modal--single-mode"))},bootstrap:function(){b.initialized||(b.checkModal(),b.checkImages(),b.initialized=!0)},switchImage:function(a){b.currentIndex=a;var c,g;0===b.currentIndex%2?(c=b.modalImage1,g=b.modalImage2):(c=b.modalImage2,g=b.modalImage1);g.setAttribute("title","");b.modalCaption.innerText="";c.src=b.images[a][0];if(a=b.images[a][1])c.setAttribute("title",
...
function $formDecorateFieldAsPhone(a,c){var b=$one(a);$formFieldAttachKeypressNumericalHandler(b,c||"[0-9.+-]")}function $formFieldAttachKeypressNumericalHandler(a,c){var b=RegExp(c);$on(a,"keypress",function(a){if("paste"===a.type)c=(event.clipboardData||window.clipboardData).getData("text/plain");else var c=a.keyCode||a.which,c=String.fromCharCode(c);b.test(c)||(a.returnValue=!1,a.preventDefault&&a.preventDefault())})};var $form=function(){var a,c,b,d,e,g,f,n,m;function k(a,b){E&&("undefined"!==typeof b?console.debug(a,b):console.debug(a))}function r(a){a.forEach(function(a){k("! disable",a.name||a.id||a.className||a.type);a.setAttribute("disabled","disabled")})}function t(a){a.forEach(function(a){k("enable",a);a.removeAttribute("disabled")})}function l(x,l){if(!this)throw'$form: You forgot to use "new" to create the object';if(!x)throw"$form: You did not provide any element";h=$one(x);if(!h)throw"$form: element not found for: "+
x;l=l||{};a=l.action||!1;c=l.validClass||"is-valid";b=l.validClass||"is-invalid";d=l.dirtyClass||"is-dirty";e=l.pristineClass||"is-pristine";g=l.fieldParentSelector||"div";f=l.disableSubmit||!1;y=l.onFormValidate||null;n=l.alertSubmit||!1;m=l.errorMessageClass||"error-message";var B=l.debounceTime||300;C=$debounce(this.validate.bind(this),B,!1);D=$debounce(this.validateField.bind(this),B,!1);h.setAttribute("novalidate","");f&&(u=h.querySelectorAll("input[type=submit]"),r(u));w=h.querySelectorAll("input[type=reset],input[type=button]");
r(w);var F=this;h.querySelectorAll('input:not([type="submit"]):not([type="reset"]),textarea,select').forEach(function(a){k("! initialize",a.name||a.id);a.isDirty=!1;$on(a,"blur",function(a){k("! ON blur",a.target.name||a.target.id);C()});$on(a,"input",function(b){k("! ON input",b.target.name||b.target.id);p=a.isDirty=!0;D(b.target.name||b.target.id)})});h.addEventListener("submit",function(b){k("! on submit");b.preventDefault();F.validate()?a&&h.setAttribute("action",a):(v&&$scrollIntoView(v),n&&
$alert("ATTENZIONE",n))})}var E=!1,s={},z={},A={},p=!1,q=!1,h=null,C=null,D=null,y=null,w=null,u=null;m=n=f=g=e=d=b=c=a=void 0;var v=null;l.prototype.addValidator=function(a,b){s.hasOwnProperty(a)||(s[a]=[]);s[a].push(b);k("- addValidator =",s);return this};l.prototype.validate=function(){k("! validate()...");var a=this._checkForm();this._reportForm(a);return q};l.prototype._checkForm=function(){var a=!0;v=null;for(var b in s){var c=this.checkField(b);!0!==c&&(a=!1);this.reportField(b,c)}y&&(k("-- calling onFormValidate..."),
a=y(h,a));k("-- _checkForm =",a);return a};l.prototype.checkField=function(a){k("- checkField()...",a);if(!s.hasOwnProperty(a))return console.warn("$form::checkField, does not exists: ",a),!0;for(var b=s[a],c=0;c<b.length;c++){var d=b[c],e=this.getFieldValue(a),d=d(e);if(!0!==d)return k("-- check failed terminating",d),d}return!0};l.prototype.getFieldObject=function(a){if(z.hasOwnProperty(a))return z[a];var b=h.querySelector('[name="'+a+'"],[id="'+a+'"]');return z[a]=b};l.prototype.getFieldErrorMessageObject=
function(a,b){if(A.hasOwnProperty(a))return A[a];if(b){var c=document.createElement("div");$addClasses(c,m);A[a]=c;b.appendChild(c);return c}return null};l.prototype.getFieldValue=function(a){var b=this.getFieldObject(a);if("radio"===b.type)return a=h.querySelector('[name="'+a+'"]:checked,[id="'+a+'"]:checked'),!a?null:a.value;if("checkbox"===b.type){a=h.querySelectorAll('[name="'+a+'"]:checked,[id="'+a+'"]:checked');if(0===a.length)return null;for(var b=[],c=0;c<a.length;c++)b.push(a[c].value);return b}return b.value};
l.prototype.reportField=function(a,l){var f=this.getFieldObject(a);if(f){var h=$closest(f,g);if(!0===l){$removeClass(h,b);$addClass(h,c);f.isValid=!0;var k=this.getFieldErrorMessageObject(a,null);k&&(k.innerHTML="")}else{$addClass(h,b);$removeClass(h,c);f.isValid=!1;if(k=this.getFieldErrorMessageObject(a,h))k.innerHTML=l;null===v&&(v=f)}f.hasOwnProperty("isDirty")&&(f.isDirty?($addClass(h,d),$removeClass(h,e)):($addClass(h,e),$removeClass(h,d)))}else console.warn("$form::reportField, cannot find element for:",
a)};l.prototype._reportForm=function(a){!0===a?(q=!0,$removeClass(h,b),$addClass(h,c),u&&t(u)):(q=!1,u&&r(u),$addClass(h,b),$removeClass(h,c));p&&w&&(t(w),w=null)};l.prototype.getFirstWrongElement=function(){return v};l.prototype.validateField=function(a){var b=this.checkField(a);this.reportField(a,b);return b};return l}();var $dialog=function(){function a(a){a=a||{};var f=a.title||"",k=a.className||"",m=a.disableDismiss||!1,n=Array.isArray(a.buttons)?a.buttons:[],p=a.content||"",q=a.spinner||"",h=a.disableClose||!1;g=a.promiseCallback||null;t=!!a.allowScroll;b=$id(c);if(!b){d=document.createElement("div");$addClass(d,"dialog-window__inner");e=document.createElement("button");$addClass(e,"dialog-window__close");e.innerHTML="&times;";a=document.createElement("div");$addClass(a,"dialog-window");a.appendChild(e);a.appendChild(d);
...
a.className="btn "+k,a.innerHTML=f,a.onclick=this.hide.bind(this,h),q.appendChild(a)}this.show()}var c="vanilla-dialog",b=null,d=null,e=null,g=null,f=!1,n=0,m="",k="",r="",t=!1;a.prototype.hide=function(a){f?(f=!1,t||(document.body.style.position=m,document.body.style.width=k,window.scrollTo(0,n),document.documentElement.style.scrollBehavior=r),$removeClass(b,"open"),$empty(d),g&&isFunction(g)&&g(a)):console.warn("$dialog: already closed")};a.prototype.show=function(){f?console.warn("$dialog: already open"):
(f=!0,$addClass(b,"open"),t||(n=$windowScrollTop(),m=document.body.style.position,k=document.body.style.width,r=document.documentElement.style["scroll-behavior"],document.body.style.position="fixed",document.body.style.top="-"+n+"px",document.body.style.width="100%",document.documentElement.style.scrollBehavior="auto"))};a.prototype.then=function(a){g=a;return this};a.prototype.getStatus=function(){return!!f};return a}();
